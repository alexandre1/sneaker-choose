...
import com.vaadin.flow.server.VaadinSession;
	...
	@Route("ShopShoesPaidHistoric")
	@CssImport("./styles/shared-styles.css")
	@CssImport(value = "./styles/vaadin-text-field-styles.css", themeFor = "vaadin-text-field")
	@SuppressWarnings("serial")

	public class ShopShoesPaidHistoric extends VerticalLayout {
			  ...
			  private static final String LABEL_SIZE_SHOES_SOLD = "lbl_number_of_shoes_sold";
		     ...
		     */
		    public ShopShoesPaidHistoric(@Autowired GreetService service, @Autowired ShoeService shoeService, @Autowired ShopService shopService) {
		    ...
		    private void buildGrid () {
		    	...
		    	labelSize = new Label(provider.getTranslation(LABEL_SIZE_SHOES_SOLD, getLocale()) + result.size());
		    	add(labelSize);
