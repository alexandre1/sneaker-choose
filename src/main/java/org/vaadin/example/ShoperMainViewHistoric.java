 ...
 * browser tab/window.
 */
@Route("ShoperMainViewHistoric")
@CssImport("./styles/shared-styles.css")
@CssImport(value = "./styles/vaadin-text-field-styles.css", themeFor = "vaadin-text-field")
@SuppressWarnings("serial")

public class ShoperMainViewHistoric extends VerticalLayout {
     ...
     */
    public ShoperMainViewHistoric(@Autowired GreetService service, ShoeService shoeService, @Autowired PersonService personService) {
    ...
    private Button createDeleteButton(Grid<ShoeRequest> grid, ShoeRequest item) {
        @SuppressWarnings("unchecked")
    	Shoe shoes = new Shoe();
